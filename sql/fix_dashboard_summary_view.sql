...
-- Add helpful comment
COMMENT ON VIEW dashboard_summary IS 'Dashboard summary with averages calculated for active patients only - Updated for better metrics';
...
BEGIN
    ...
    RAISE NOTICE '✅ More meaningful dashboard statistics';
END $$; 